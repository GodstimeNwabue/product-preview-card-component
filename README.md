...
You can use any tools you like to help you complete the c ioihallenge. So if you've got something you'd like to practice, feel free to give it a go.
...
Learnt how to use media queries effectively on "min-width". Understanding it and how it affects other dimensions.
